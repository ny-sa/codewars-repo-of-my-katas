...
//My solution
function getMiddle(s)   //No native methods challenge
{
    return s.length % 2 ? s[s.length/2 - 0.5] : s[s.length/2 - 1] + s[s.length/2];  //accesses the middle element directly instead
}
